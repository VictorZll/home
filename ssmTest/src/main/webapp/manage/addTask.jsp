...
<div class="container">
    <div class="content">
        <div title="纳税人信息" data-options="closable:false" class="basic-info">
            ...
            <table class="kv-table">
                ...
                <tr>
                    ...
                    <td class="kv-content"><input type="text" name="taskname" placeholder="请输入任务名称"  class="easyui-validatebox" data-options="required:true,validate:['CHS','minLength[4]']"></td>
                ...
                <tr>
                    ...
                    <td class="kv-content">
                        <textarea name="taskstate" rows="3" style="width: 90%;" class="easyui-validatebox" data-options="required:true,validate:['CHS','minLength[2]']" ></textarea>
                    </td>
                    <td class="kv-label">调查结论和意见</td>
                    <td class="kv-content" colspan="3">
                        <textarea name="idea" rows="3" style="width: 90%;"  class="easyui-validatebox" data-options="required:true,validate:['CHS','minLength[2]']" ></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="btn-selection">
            <a id="save" href="javascript:void(0);" class="easyui-linkbutton save-btn" data-options="selected:true">保存</a>
...
<script>
//格式化fm1
$("#fm1 input:not([name=payerCode])").prop("readOnly",true);
//初始化录入日期，日期框
$("#datebox").datebox({
...
$("#fm2").form({
	...
	onSubmit:function(param){
		...
		if($("select[name=risklevel] option:checked").val()==0){
			$.messager.alert("警告","请选择风险类型");
			return false;
		}
		if($("select[name=approverid] option:checked").val()==-1){
			$.messager.alert("警告","请选择批准人");
			return false;
		}
		if($("select[name=executeid] option:checked").val()==-1){
			$.messager.alert("警告","请选择执行人");
			return false;
		}
		if($("select[name=suborganid] option:checked").val()==-1){
